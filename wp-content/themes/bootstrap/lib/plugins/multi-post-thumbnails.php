...
//				wp_enqueue_script( "mpt-featured-image", $this->plugins_url( 'js/multi-post-thumbnails-admin.js', __FILE__ ), array( 'jquery', 'set-post-thumbnail' ) );
				wp_enqueue_script( "mpt-featured-image", get_stylesheet_directory_uri() .'/lib/js/multi-post-thumbnails-admin.js', array( 'jquery', 'set-post-thumbnail' ) );
				...
				wp_enqueue_script( "mpt-featured-image-modal", get_stylesheet_directory_uri() .'/lib/js/media-modal.js', array( 'jquery', 'media-models' ) );				
			}
		}
